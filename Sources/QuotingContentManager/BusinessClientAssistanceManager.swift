...
public struct BusinessClientAssistanceManager: Sendable {
    public var items: [Item] = [
        ...
        .init(
            uniqueCode: "3",
            name: "配合及時提供相關資訊",
            content: "為順利達成上述服務， 貴公司除應提供相關之會計資訊、文件及憑證等，供本事務所審閱，並答覆有關問題之詢問，亦應保證上述資料之真實性。貴公司會計人員應對\(TemplateVariableConcept.accountingWorkName.placeholder())工作儘量協助，此項協助包括憑證蒐集、對帳、提供有關文件資料、相關問題詢問等；至於其具體配合事項，將由本事務所之服務人員於工作開始前，提供應備資料清單，商請 貴公司有關人員惠予配合。前述資料如有因 貴公司延遲提供以致影響本事務所工作，或導致 貴公司委託之簽證或服務無法於法定期間內完成，本事務所不負擔任何責任，且本事務所得隨時終止委託。"
        ),
    ]
