...
extension QuotingContentManager {
    public var contractHeader: Copywriting {
        get {
            .init(title: "承 貴公司委任本事務所辦理有關%ServiceItemNames%之專業服務，至深感荷。謹將服務內容及酬金等分別說明如後，敬請卓察賜覆為禱。", content: "感謝 貴公司對本事務所的支持與愛護，本事務所本著積極服務顧客的熱忱，以及專業智慧的多元服務，特將本事務所受託辦理有關%ServiceItemNames%之專業服務內容概述如後，期盼此項合作能協助 貴公司提升%AccountingWorkName%品質，俾能符合相關稅務法令和企業會計準則之規定。茲將委任之目的、服務範圍、 貴公司協助事項、酬金、權利義務事項及同意函列示如下:")
        }
    }
